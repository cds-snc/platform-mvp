...
<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e('Skip to content', THEME_NAMESPACE); ?></a>
<header>
    <div id="wb-bnr" class="container">
        <div class="row">
            ...
            <section id="wb-srch" class="col-lg-offset-4 col-md-offset-4 col-sm-offset-2 col-xs-12 col-sm-5 col-md-4">
                <h2><?php _e('Search', THEME_NAMESPACE); ?></h2>
                <form action="/<?php echo $langText['abbr']; ?>/sr/srb.html" method="post" name="cse-search-box"
                      role="search">
                    <div class="form-group wb-srch-qry">
                        <label for="wb-srch-q" class="wb-inv"><?php _e('Search Canada.ca', THEME_NAMESPACE) ?></label>
                        <input id="wb-srch-q" list="wb-srch-q-ac" class="wb-srch-q form-control" name="q" type="search"
                               value="" size="34" maxlength="170" placeholder="<?php _e('Search Canada.ca', THEME_NAMESPACE) ?>">
    ...
    <nav class="gcweb-menu" typeof="SiteNavigationElement">
        <div class="container">
            <h2 class="wb-inv"><?php _e('Menu', THEME_NAMESPACE); ?></h2>
            <button type="button" aria-haspopup="true" aria-expanded="false"><span
                        class="wb-inv"><?php _e('Main', THEME_NAMESPACE); ?> </span><?php _e('Menu', THEME_NAMESPACE); ?> <span

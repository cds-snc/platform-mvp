...
function cds_scripts() {
	wp_enqueue_style( 'cds-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'cds-style', 'rtl', 'replace' );

	wp_enqueue_script( 'cds-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );

 ...
 */
function cds_content_width(): void
{
 ...
 */
function cds_widgets_init(): void
{
    register_sidebar(
        [
...
function cds_scripts(): void
{
    ...
    wp_enqueue_script('cds-navigation', get_template_directory_uri() . '/js/navigation.js', [], _S_VERSION, true);

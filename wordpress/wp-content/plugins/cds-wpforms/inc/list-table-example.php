...
class CDS_Example_List_Table extends WP_List_Table
{
     ...
     */
    public function column_default(array $item, array $column_name): string
    {
        switch ($column_name) {
            case 'email':
...
//Show the whole array for troubleshooting purposes
     ...
     * @return string Text to be placed inside the column <td> (movie title only)
     */
    public function column_cb(array $item): string
    {
        return sprintf(
 ...
 */
function cds_add_menu_items(): void
{
 ...
 */
function cds_render_list_page(): void
{
